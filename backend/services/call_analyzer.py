...
_ANALYSIS_PROMPT = """You are an expert sales coach for a fence staining company (A&T's Fence Staining, Cypress TX). Analyze this sales call transcript and provide actionable coaching.
