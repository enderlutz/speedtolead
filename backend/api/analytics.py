...
def get_kpis():
    ...
    try:
        ...
        for est, lead in pairs:
            c = _parse_dt(getattr(lead, "dashboard_synced_at", None)) or _parse_dt(lead.created_at)
...
def get_speed_metrics():
    ...
    try:
        ...
        for est, lead in pairs:
            created = _parse_dt(getattr(lead, "dashboard_synced_at", None)) or _parse_dt(lead.created_at)
