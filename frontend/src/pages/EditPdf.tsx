  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      const vals: Record<string, string> = {
        ...
        essential_monthly: `$${(tiers.essential / 21).toFixed(2)}/mo for 21 mos`,
        signature_monthly: `$${(tiers.signature / 21).toFixed(2)}/mo for 21 mos`,
        legacy_monthly: `$${(tiers.legacy / 21).toFixed(2)}/mo for 21 mos`,
