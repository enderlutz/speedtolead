...
export const PRESET_FIELD_LABELS: Record<string, string> = {
  ...
  essential_monthly: "Essential — Affirm monthly financing",
  signature_monthly: "Signature — Affirm monthly financing",
  legacy_monthly: "Legacy — Affirm monthly financing",
